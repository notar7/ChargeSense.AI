...
export default function CarbonTracker() {
  const [carbonSaved, setCarbonSaved] = useState(1247.34);

  useEffect(() => {
    const interval = setInterval(() => {
      setCarbonSaved(prev => prev + 0.04);
    }, 1000);
  ...
  return (
    <div className="space-y-6 animate-fade-in text-slate-800">
      ...
      <div className="flex justify-between items-center border-b border-slate-200 pb-4">
        <div>
          ...
          <p className="text-[0.65rem] text-slate-500 font-mono tracking-widest mt-1 uppercase">
            Real-time acceleration metrics // net zero 2030
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 light-card p-6 flex flex-col justify-between relative overflow-hidden">
          <div>
            ...
            <div className="flex items-baseline gap-3 mt-1">
              <span className="text-4xl md:text-5xl font-black text-slate-900 font-mono tracking-widest">
                {carbonSaved.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </span>
        ...
        {/* Impact Level card */}
        <div className="light-card p-6 flex flex-col justify-between relative overflow-hidden">
          <div>
            ...
            <h3 className="text-base font-bold text-slate-900 mt-2 font-mono uppercase">
              LEVEL 04 // OPERATIONAL
            </h3>
            <p className="text-xs text-slate-500 mt-2 leading-relaxed font-semibold">
              Replacement rate is offsetting carbon 18% faster than regional benchmarks.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-8 light-card p-5 flex flex-col justify-between min-h-[320px]">
          <div>
          ...
          <div className="border-t border-slate-100 pt-3 mt-4 text-center">
            <span className="text-[0.55rem] text-slate-400 font-mono tracking-wider uppercase">
              *Calculation based on diesel carbon metrics
            </span>
          </div>
        </div>
          ...
          <div className="space-y-3.5 flex-1">
            ...
            <div className="bg-white border border-slate-200 p-4 rounded-xl flex items-start gap-3 shadow-sm">
              ...
              <div>
                ...
                <p className="text-[0.6rem] text-red-500 font-bold uppercase mt-1">⚠️ 12% INITIATED</p>
              </div>
            </div>
          </div>
        </div>
